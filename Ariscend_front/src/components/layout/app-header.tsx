    ...
    <header className="sticky top-0 z-40 border-b border-white/[0.06] bg-black/85 backdrop-blur-xl">
      <div className="mx-auto flex h-16 max-w-[1200px] items-center justify-between px-4 md:h-20 md:px-8">
        ...
        <div className="flex items-center gap-2">
          ...
          <Link href="/ajustes" className="focus-ring rounded-full p-2 text-[#a9abad] transition hover:bg-white/[0.06] hover:text-white" aria-label="Ajustes">
            <Settings className="size-5" />
          </Link>
          <Link href="/seleccionar-usuario" className="focus-ring rounded-full p-2 text-[#a9abad] transition hover:bg-white/[0.06] hover:text-white" aria-label="Cambiar usuario">
