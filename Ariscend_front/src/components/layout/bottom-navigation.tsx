...
export function BottomNavigation() {
  ...
  return (
    <nav className="glass-panel fixed bottom-4 left-1/2 z-50 flex w-[calc(100%-32px)] max-w-[560px] -translate-x-1/2 items-center justify-around rounded-full px-3 py-2.5 md:bottom-6 md:w-auto md:gap-7 md:px-9">
      {items.map((item) => {
        ...
        return (
          <Link
            ...
            className={cn(
              ...
              active ? "text-white" : "text-[#747679] hover:text-white",
            )}
          >
