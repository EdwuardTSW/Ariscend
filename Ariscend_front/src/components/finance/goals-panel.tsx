...
import { currencyOptions, formatMoney, inputClass, labelClass, localDateKey } from "@/lib/finance-utils";
...
export function GoalsPanel() {
  ...
  useEffect(() => {
    ...
    Promise.all([
      ...
      setGoalCurrency(financeSettings.baseCurrency);
